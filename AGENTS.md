...
| `data-preparation` | “准备数据 {code}”<br>“抓取数据 {code}” | `data-preparation` | `$fetch-data` | 105 |
| `deep-research` | “深度分析 {code}”<br>“深研 {code}” | `deep-research` | `$deep-stock-analysis` | 100 |
| `deploy` | “发布”<br>“deploy” | `deploy` | `$deploy` | 50 |
| `development` | “开发 {task}”<br>“修复 {task}” | `development` | — | 110 |
...
| `quant-analysis` | “量化分析 {code}”<br>“计算指标 {code}” | `quant-analysis` | `$tech-indicators` | 105 |
