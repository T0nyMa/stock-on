...
读 `data/{code}/` 下 kline.json (近7日), indicators.json, quote.json
...
- 高位出现 → 可能是诱多出货
- indicators.json → trend.support_levels
...
用 Write 工具写入 `data/{code}/strategy_one_yang_three_yin.json`
