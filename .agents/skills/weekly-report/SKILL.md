...
- consumes: `snapshot.indicators`, `artifact.report_context`, `artifact.tracklist`, `artifact.position`, `artifact.research_summary`, `artifact.financial_collection_status`, `artifact.daily_report`
- produces: `artifact.weekly_report`
- policies: `DATA.QUALITY`, `RESEARCH.EVIDENCE`, `DECISION.SEPARATION`, `PUBLISH.COMPLETE`
