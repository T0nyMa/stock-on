...
- Workflow: `position-decision`
- Policies: `DATA.QUALITY`, `RESEARCH.EVIDENCE`, `DECISION.SEPARATION`
- Consumes: `snapshot.indicators`, `artifact.report_context`, `artifact.research_summary`, `artifact.financial_quality_summary`, `artifact.discovery_report`, `artifact.strategy_scan`
- Produces: `artifact.tracklist`, `artifact.position`
